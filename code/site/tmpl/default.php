...
<?php if ($params->get('descriptiontemplate', $defaults['descriptiontemplate']) == 'independenttemplate') :?>
    ...
    <div id="sliderb_container" style="position: relative; width: <?php echo $params->get('width', $defaults['width']) ?>px;
        ...
        <!-- Arrow Left -->
        <span u="arrowleft" class="jssord05l" style="width: 40px; height: 40px; <?php if ($params->get('descriptionposition_outside', $defaults['descriptionposition_outside']) == 'rightdescind' or 'bottomdescind') :?>top: <?php echo $params->get('width', $defaults['width']) / 4 - 40 ?>px; left: 8px;<?php endif; ?> <?php if ($params->get('descriptionposition_outside', $defaults['descriptionposition_outside']) == 'leftdescind') :?>left:<?php echo $params->get('width_desc_outside', $defaults['width_desc_outside'])+20 ?>px; top:<?php echo $params->get('width', $defaults['width']) / 4 - 40 ?>px;<?php endif; ?> <?php if ($params->get('descriptionposition_outside', $defaults['descriptionposition_outside']) == 'topdescind') :?>top: <?php echo $params->get('width', $defaults['width']) / 4 + $params->get('height_desc_outside', $defaults['height_desc_outside']) ?>px; left: 8px;<?php endif; ?>">
        </span>
        <!-- Arrow Right -->
        <span u="arrowright" class="jssord05r" style="width: 40px; height: 40px; <?php if ($params->get('descriptionposition_outside', $defaults['descriptionposition_outside']) == 'rightdescind') :?>top: <?php echo $params->get('width', $defaults['width']) / 4 - 40 ?>px; right: <?php echo $params->get('width_desc_outside', $defaults['width_desc_outside']) + 18 ?>px <?php endif; ?> <?php if ($params->get('descriptionposition_outside', $defaults['descriptionposition_outside']) == 'bottomdescind') :?>top: <?php echo $params->get('width', $defaults['width']) / 4 - 40 ?>px; right: 8px <?php endif; ?><?php if ($params->get('descriptionposition_outside', $defaults['descriptionposition_outside']) == 'topdescind') :?>top: <?php echo $params->get('width', $defaults['width']) / 4 + $params->get('height_desc_outside', $defaults['height_desc_outside'])?>px; right: 8px <?php endif; ?> <?php if ($params->get('descriptionposition_outside', $defaults['descriptionposition_outside']) == 'leftdescind') :?>top: <?php echo $params->get('width', $defaults['width']) / 4 - 40 ?>px; right: 8px <?php endif; ?>">
        </span>
